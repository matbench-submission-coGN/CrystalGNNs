...
class CrystalInputBlock(GraphNetworkBase):
    ...
    def __init__(self,
        ...
        Args:
            atom_embedding (crystalgnns.kgcnn_layers.embedding_layers.atom_embedding.AtomEmbedding):
                AtomEmbedding layer to use for graph nodes.
            edge_embedding (crystalgnns.kgcnn_layers.embedding_layers.edge_embedding.EdgeEmbedding):
