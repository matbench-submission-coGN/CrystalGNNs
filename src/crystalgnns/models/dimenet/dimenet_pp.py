...
from kgcnn.layers.geom import NodeDistanceEuclidean, EdgeAngle, BesselBasisLayer, NodePosition, ShiftPeriodicLattice, EuclideanNorm
...
def make_model(inputs: list = None,
    ...
    model = ks.models.Model(inputs=[node_input, offsets, bond_index_input, angle_index_input],
                            outputs=out)
